  ...
  render() {
    ...
    return (
      <View style={styles.deck}>
        <View style={styles.deckLargeBuffer}></View>
        ...
        <View style={styles.deckButtons}>
          <TouchableOpacity
            onPress={() => {
              navigation.navigate("Add Card", params);
            }}
          >
        ...
        <View style={styles.deckSmallBuffer}></View>
      </View>
    );
  }
}
...
const mapStateToProps = (state, props) => {
  ...
  const numCards = deck ? Object.keys(deck.cards).length : 0;
  return { numCards };
};
