    ...
    render() {
        ...
        const questionJSX = showAnswer ? (
            <View style={styles.quizQuestionAnswer}>
                <Text style={styles.quizQuestionAnswerText}>{currentQuestion.answer}</Text>
                <TouchableOpacity
            ...
            <View style={styles.quizQuestionAnswer}>
                <Text style={styles.quizQuestionAnswerText}>{currentQuestion.question}</Text>
                <TouchableOpacity
                    onPress={this.toggleAnswerDisplay}
                >
            ...
            return (
                <View style={styles.quiz}>
                    ...
                    <View style={[styles.quizButton, {backgroundColor: 'black'}]}>
                      <Text style={[styles.quizButtonText, {color: 'white'}]}>Back To Deck</Text>
                    </View>
                    </TouchableOpacity>
                    </View>
                    <View style={styles.quizBufferSmall}></View>             
        ...
        return (
            <View style={styles.quiz}>
                <View style={styles.quizProgress}>              
                  <Text style={styles.quizProgressText}>{`${numCorrect}/${numAnswered}`}</Text>
                </View>
                <View style={styles.quizBufferLarge}></View>
                {questionJSX}
                <View style={styles.quizBufferSmall}></View>                
                ...
                >
                    <View style={[styles.quizButton, {backgroundColor: 'green'}]}>
                      <Text style={[styles.quizButtonText, {color: 'white'}]}>Correct</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                    <View style={[styles.quizButton, {backgroundColor: 'red'}]}>
                      <Text style={[styles.quizButtonText, {color: 'white'}]}>Incorrect</Text>
                    </View>
                </TouchableOpacity>
                </View>
                <View style={styles.quizBufferSmall}></View>                    
